...
<div class="col-md-12"> 
    ...
    ?>
                                           <a href="w9_pdf_download.php?tid=<?php echo $_GET['tid'];?>" class="btn btn-warning" style="float:right;margin-bottom: 7px;margin-top: 7px;margin-left: 5px">Download W-9 Form</a>
        <?php } ?>
    <a href="pdf_applicant_download.php?tid=<?php echo $_GET['tid'];?>" class="btn btn-success" style="float:right;margin-bottom: 7px;margin-top: 7px">Download PDF</a></div>
