            ...
            <br> <br>	
				<div class="page-content" style="background-image: url('images/wizard-v3.jpg')">
									        ...
									        <div class="page-container">
												<div class="row">
													...
													<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                                                                            <div class="requester-left" style="padding-bottom:7px">
														    ...
														    <div class="tax-form-form">
															     <div class="form-group">
																	...
																	<label for="pwd">2 Business name/disregarded entity name, if different from above</label>
                                                                                                                        ...
                                                                                                                        <div class="form-group" style="padding-left:20px">
																	<?php echo $form_3_arr['business_name'];?>
																  </div>
																  <div class="row" style="border-bottom:1px solid #000;">
																        <div class="col-md-8" style="padding:0px;margin-top: 15px">
																	        <div class="form-group">
                                                                                                                                                    <label for="pwd" style="margin-top:15px">Check appropriate box for federal tax classification of the person whose name is entered on line 1. Check only one of the following seven boxes</label>
																				<br />
                                                                                                                                                                <label class="checkbox-inline">
                                                                                                                                                                    <input name="tax_classification[]" style="margin-top:0px" <?php if( in_array(1, $form_3_arr['tax_classification'])) { echo 'checked';}?> type="checkbox" value="1">Individual/sole proprietor or single-member LLC
																				</label>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]" style="margin-top:0px" <?php if( in_array(2, $form_3_arr['tax_classification'])) { echo 'checked';}?> type="checkbox" value="2"> C Corporation 
																				</label>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]" style="margin-top:0px" <?php if( in_array(3, $form_3_arr['tax_classification'])) { echo 'checked';}?> type="checkbox" value="3">S Corporation 
																				</label>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]" style="margin-top:0px" <?php if( in_array(4, $form_3_arr['tax_classification'])) { echo 'checked';}?> type="checkbox" value="4">Partnership
																				</label>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]" style="margin-top:0px" <?php if( in_array(5, $form_3_arr['tax_classification'])) { echo 'checked';}?> type="checkbox" value="5">Trust/estate
																				</label><br>
																				<label class="checkbox-inline">
																				  <input name="tax_classification[]" style="margin-top:0px" <?php if( in_array(6, $form_3_arr['tax_classification'])) { echo 'checked';}?> type="checkbox" value="6">Limited liability company. Enter the tax classification (C=C corporation, S=S corporation, P=Partnership <input type="text" class="inline-vvv" id="pwd" value="<?php echo $form_3_arr['limited_liability_text'];?>">
																				</label>
                                                                                                                                                                <br />
																			    ...
																			    <div class="form-group">
																				 ...
																				 <div class="form-group">
																					<label for="email">Exempt payee code (if any)</label>
                                                                                                                                                                ...
                                                                                                                                                                <div class="form-group" style="padding-left:20px">
                                                                                                                                                                      <?php echo $form_3_arr['exempt_payee_code'];?>
                                                                                                                                                                </div>
																				 <div class="form-group">
																					<label for="email">Exemption from FATCA reporting code (if any)</label>
																				 </div>
                                                                                                                                                                <div class="form-group" style="padding-left:20px">
                                                                                                                                                                      <?php echo $form_3_arr['exempt_from_fatca'];?>
                                                                                                                                                                </div>
																  ...
																  <div class="row">
																        <div class="col-md-7" style="padding:0px;">
																				...
																				<label for="email">5 Address (number, street, and apt. or suite no.) See instructions.</label>
                                                                                                                                            ...
                                                                                                                                            <div class="form-group" style="padding-left:20px">
                                                                                                                                                                      <?php echo $form_3_arr['income_tax_address'];?>
                                                                                                                                                                </div>
																	        <div class="form-group">
																				<label for="email">6 City, state, and ZIP code</label>
                                                                                                                                            ...
                                                                                                                                            <div class="form-group" style="padding-left:20px">
                                                                                                                                                                      <?php echo $form_3_arr['income_tax_address_city'];?>
                                                                                                                                                                </div>
																	    </div>
																	         ...
																	         <div class="tax-right">
																				 <div class="form-group">
																					<label for="email">Requester's name and address (optional)</label>
                                                                                                                                                     ...
                                                                                                                                                     <div class="form-group" style="padding-left:20px">
                                                                                                                                                                      <?php echo $form_3_arr['income_tax_name_and_address'];?>
                                                                                                                                                                </div>
																			 </div>
																  ...
																  <div class="form-group">
																		<label for="email">7 List account number(s) here (optional)</label>
                                                                                                                        ...
                                                                                                                        <div class="form-group" style="padding-left:20px">
                                                                                                                                                                      <?php echo $form_3_arr['list_account_number'];?>
                                                                                                                                                                </div>
															</div>
														 </div>
													</div>
														  ...
														  <div class="col-md-5 col-lg-5 col-xs-5 col-sm-5"> 
														    <div class="form-group">
																...
																<div class="sms-verification-simple">
																  <input type="text" name="social_security_number" class="form-control" maxlength="9" value="<?php echo $form_3_arr['social_security_number'];?>" aria-describedby="basic-addon1">
															...
															<div class="form-group">
																...
																<div class="sms-verification-simple">
																  <input name="employer_identification_number " type="text" class="form-control" maxlength="9" value="<?php echo $form_3_arr['employer_identification_number '];?>" aria-describedby="basic-addon1">
																  <span></span><span></span><span></span><span></span>
																</div>
															</div>
														 </div>
										   ...
										   <div >		        
										        <div >
													<div class="row">
														<div class="page-number row"><div class="text-left col-md-12 col-xs-12 col-lg-12 col-sm-12">Form W-9 (Rev. 10-2018)</div></div>
												...
												<div class="page-container">
													<div class="row">
														<div class="page-number row"><div class="text-left col-md-12">Form W-9 (Rev. 10-2018)</div></div>
													</div>
													<div class="row">
													     <div class="col-md-6">
