                                    ...
                                    <tbody id="myTable">
                                        <?php
                                            if ( mysql_num_rows($results) > 0 ) {
                                                while ( $row = mysql_fetch_assoc($results) ) {
                                                   ...
                                                   if($row['add_observer'] > 0 && $row['observer_confirm'] == 1 && $row['tut_observer_id'] > 0)
                                                    {
                                                        $tut_th= mysql_fetch_assoc(mysql_query("SELECT id,f_name,lname FROM gig_teachers WHERE id=".$row['tut_observer_id']));  
                                                        $profile= mysql_fetch_assoc(mysql_query("SELECT id,payment_email,payment_phone FROM tutor_profiles WHERE tutorid=".$row['tut_observer_id']));
                                                    }
                                                    else
                                                    {
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                             <?php if($row['add_observer'] > 0 && $row['observer_confirm'] == 1 && $row['tut_observer_id'] > 0) { ?>
                                                            <strong class="text-primary">Observer: </strong><?=$tut_th['f_name']." ".$tut_th['lname']?>
                                                            <?php } else { ?>
