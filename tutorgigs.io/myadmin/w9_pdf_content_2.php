				...
				<div class="page-content" style="background-image: url('images/wizard-v3.jpg')">
									        ...
									        <div class="page-container">
														 ...
														 <div class="col-md-11">
														    <div class="tax-form-form">
															     <div class="form-group">
																	...
																	<input type="text" name="name_income_tax" readonly="" value="Nick Mathew" placeholder="name" class="form-control-2" id="email">
																  </div>
																  <div class="form-group">
																	         ...
																	         <div class="tax-right" style=" min-height: 290px;">
																			    <div class="form-group">
																				 ...
																				 <div class="form-group">
																					...
																					<input placeholder="Exempt payee code" required="" name="exempt_payee_code" type="text" class="form-control-2" id="email">
																				 </div>
																				 <div class="form-group">
																					<label for="email">Exemption from FATCA reporting code (if any)</label>
																					<input placeholder="Exemption from FATCA" required="" name="exempt_from_fatca" type="text" class="form-control-2" id="email">
																				 </div>
																  ...
																  <div class="row">
																        <div class="col-md-7" style="padding:0px;">
                                                                            <div class="form-group">
																				...
																				<input placeholder="Address" required="" name="income_tax_address" type="text" class="form-control-2" id="email">
																			</div>
																	        <div class="form-group">
																				<label for="email">6  City, state, and ZIP code</label>
																				<input placeholder="City, state, and ZIP code" required="" name="income_tax_address_city" type="text" class="form-control-2" id="email">
																			</div>
																	    </div>
																  ...
																  <div class="form-group">
																		...
																		<input placeholder="List account number(s)" required="" type="text" name="list_account_number" class="form-control-2" id="email">
																  </div>
															</div>
														 </div>
													</div>
												...
												<!-- <p> Show signature form data</p> -->
																								...
																								<input type="hidden" id="sign_name" name="sign_name" value="Nick">
															...
															<div class="col-md-10">
															      <div class="form-inline">
																	  ...
																	  <div class="form-group">
																		<label for="pwd"> Date:</label>
																		<!-- <input placeholder="date" name="signature_date" type="date" class="form-control-3"> -->
																		<input placeholder="date" readonly="" name="signature_date" type="text" value="25/01/2021" class="form-control-3">
																	  </div>
																   </div> 
															</div>
														</div>
